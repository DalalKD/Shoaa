    ...
    private void uploadImageToFirebase(String name, final Uri contentUri) {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        fStore
                                ...
                                .update("selectedImage",image.toString());

                        Toast.makeText(CapturePicture.this, "Image Is Uploaded.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CapturePicture.this, "Upload Failled.", Toast.LENGTH_SHORT).show();
